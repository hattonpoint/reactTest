...
var OmOPPartItems = React.createClass({
    render: function () {
        ...
        return (
<table className="table table-condensed omOPPartItems">
    {partItems}
</table>
    )
...
var OmOPPackageList = React.createClass({
    render: function () {
...
<td colSpan="7" className="package-items-container">
    <OmOPPartItems data={ompackage.PartItems}></OmOPPartItems>
</td>
</tr>
...
var OPLineItems = React.createClass({
    loadData: function (e) {
        e.preventDefault();
...
ReactDOM.render(
<OPLineItems />,
    document.getElementById('outsidepurchase-lineitems')
    );
